...
void dob::enter_date()
{
 ...
 //clreol
 //clreol
 cin>>DOB11[T1.tempo].year;
 while(DOB11[T1.tempo].year>T1.current_year)  //to ensure that the year of birth
 ...
 while(DOB11[T1.tempo].year<1000)
 {
  //clreol
 ...
 while(DOB11[T1.tempo].year<1900)
 {
  //clreol
  cout<<"\a\nAre you sure (Y/N) ? ";
  cin>>birth_answer;
  ...
  if(birth_answer=='n'||birth_answer=='N')
  {
   ...
   cin>>DOB11[T1.tempo].year;
   //clreol
   while(DOB11[T1.tempo].year>T1.current_year)
   {
    //clreol
    cout<<"Invalid input for year !!! ";
    //clreol
 ...
 cout<<"Month : ";
 //clreol
 cin>>DOB11[T1.tempo].month;
 while(DOB11[T1.tempo].month<=0||DOB11[T1.tempo].month>12)
 {
  //clreol
  cout<<"\a\nInvalid input for month !!!"<<"\n";
 ...
 switch(DOB11[T1.tempo].month)
 {
  ...
  case 10:
  case 12:{
           cin>>DOB11[T1.tempo].date;           //for months with 31 days
           while(DOB11[T1.tempo].date<1||DOB11[T1.tempo].date>31)
           {
            //clreol
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
            //clreol
            cin>>DOB11[T1.tempo].date;
            cout<<"\n";
           }
           break;
          }
  case 2:{                                  //for february
          cin>>DOB11[T1.tempo].date;
          if(DOB11[T1.tempo].year%4==0)
          {
           while(DOB11[T1.tempo].date<0||DOB11[T1.tempo].date>29)  //for leap year
           {
            //clreol
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
          ...
          {
           while(DOB11[T1.tempo].date<0||DOB11[T1.tempo].date>28)  //for non-leap year
           {
            //clreol
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
 ...
 default:{
          cin>>DOB11[T1.tempo].date;            //for other months
          while(DOB11[T1.tempo].date<1||DOB11[T1.tempo].date>30)
          {
           //clreol
           cout<<"\aInvalid date !!!"<<"\n";
           cout<<"Again enter the date : ";
